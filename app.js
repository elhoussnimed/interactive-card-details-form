...
const showExperationMonth = document.querySelector(".card .front-card div div .card-month");
const showExperationYear = document.querySelector(".card .front-card div div .card-year");
...
const cardNumberError = document.querySelector(".container .form .content .card-number .msg-error");
const expDateError = document.querySelector(".container .form .content .card-exp-cvc .exp-date p");
const cvcError = document.querySelector(".container .form .content .card-exp-cvc .cvc p");
...
function showCompleteState() {
    if (!cardNumberError.classList.contains("display") && !expDateError.classList.contains("display") && !cvcError.classList.contains("display")) {
...
// Add Margin In The Form When Inputs Are Focused 
if (window.screen.width < 768) {
holderNameInput.onfocus = () => {form.style.marginTop = "130px"};
holderNameInput.onblur = () => {form.style.marginTop = "initial"};
cardNumberInput.onfocus = () => {form.style.marginTop = "110px"};
cardNumberInput.onblur = () => {form.style.marginTop = "initial"};
monthInput.onfocus = () => {form.style.marginTop = "110px"};
monthInput.onblur = () => {form.style.marginTop = "initial"};
yearInput.onfocus = () => {form.style.marginTop = "110px"};
yearInput.onblur = () => {form.style.marginTop = "initial"};
cvcInput.onfocus = () => {form.style.marginTop = "110px"};
cvcInput.onblur = () => {form.style.marginTop = "initial"};
}

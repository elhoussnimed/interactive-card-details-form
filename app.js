...
// Modified Style In Front And Back Of Card When Focus On Mobile Screen
if (window.screen.width < 768) {
  const frontCard = document.querySelector(".container .card .front-card");
  const backCard = document.querySelector(".container .card .back-card");
  const img = document.querySelector(".front-card img");

  holderNameInput.onfocus = () => {
    img.style.marginBottom = "25px";
    frontCard.style.height = "30vh";
    backCard.style.height = "30vh";
  };
  ...
  holderNameInput.onblur = () => {
    img.style.marginBottom = "20px";
    frontCard.style.height = "18vh";
    backCard.style.height = "18vh";
  };
